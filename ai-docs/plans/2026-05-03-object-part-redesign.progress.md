...
**Last build:** ✅ cargo build + cargo test -p quartzite-macros (141 tests pass)
...
Subtask 4: Add `object_part` module; remove `#[allow(dead_code)]` from `accumulator::push`; update accumulator duplicate error message.
