...
- [ ] 6. `quartzite-renderer` crate scaffold (`Cargo.toml`, `src/lib.rs`, workspace registration)
...
| AC3 — `quartzite-renderer` has winit/wgpu/vello | NOT_TESTED (Task 6) |
