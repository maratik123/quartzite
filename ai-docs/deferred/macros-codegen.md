...
| `#[object_impl]` on generic types — orthogonal to this task | [macro-codegen-improvements spec](../plans/done/2026-05-03-macro-codegen-improvements.spec.md) |  | — |
...
| `#[derive(Extend)]` on enums or tuple structs (named fields only — existing constraint, unchanged) | [macro-codegen-improvements spec](../plans/done/2026-05-03-macro-codegen-improvements.spec.md) |  | — |
| Generic functions or blanket-impl trait methods — not affected by codegen improvements | [macro-codegen-improvements spec](../plans/done/2026-05-03-macro-codegen-improvements.spec.md) |  | — |
| Changing the public API surface of `quartzite-macros` (attribute names, derive names) | [macro-codegen-improvements spec](../plans/done/2026-05-03-macro-codegen-improvements.spec.md) |  | — |
| Multi-crate / cross-crate `#[object_impl]` collection (same compilation unit only) | [macro-codegen-improvements spec](../plans/done/2026-05-03-macro-codegen-improvements.spec.md) |  | — |
| Changing the `thread_local!` accumulator mechanism or its key format (`CARGO_PKG_NAME::type_name`) | [object-part-redesign spec](../plans/done/2026-05-03-object-part-redesign.spec.md) |  | — |
| Changing duplicate-detection behaviour or error messages | [object-part-redesign spec](../plans/done/2026-05-03-object-part-redesign.spec.md) |  | — |
| Any other proc-macro (`#[derive(Object)]`, `#[derive(Extend)]`, `#[meta_enum]`) | [object-part-redesign spec](../plans/done/2026-05-03-object-part-redesign.spec.md) |  | — |
| `dynamic_properties` — tracked by a separate issue | [objectbase-debug-rename-factory spec](../plans/done/2026-05-03-objectbase-debug-rename-factory.spec.md) |  | — |
| Any other `ObjectTree` changes beyond `rename` semantics | [objectbase-debug-rename-factory spec](../plans/done/2026-05-03-objectbase-debug-rename-factory.spec.md) |  | — |
| Hand-written `impl Trait for Type` outside `quartzite-macros` (rule is in AGENTS.md; reviewer audit covers it) | [codegen-inline-concrete-trait-impls spec](../plans/done/2026-05-07-codegen-inline-concrete-trait-impls.spec.md) |  | — |
| `// _Simple._` codegen (Rust strips comments from token streams before parsing) | [codegen-inline-concrete-trait-impls spec](../plans/done/2026-05-07-codegen-inline-concrete-trait-impls.spec.md) |  | — |
| `/// _Simple._` on trait declarations (already emitted by PRs #120/#127) | [codegen-inline-concrete-trait-impls spec](../plans/done/2026-05-07-codegen-inline-concrete-trait-impls.spec.md) |  | — |
| `where_clause` predicate inspection (bounds don't affect per-impl symbol count) | [codegen-inline-concrete-trait-impls spec](../plans/done/2026-05-07-codegen-inline-concrete-trait-impls.spec.md) |  | — |
| Non-simple methods: `read_property`, `write_property`, `invoke_method`, `from_value`, `__lookup_*`, `__connect_signal_dynamic_*` | [codegen-inline-concrete-trait-impls spec](../plans/done/2026-05-07-codegen-inline-concrete-trait-impls.spec.md) |  | — |
| Part 1 (hand-written trait declarations) — closed by PR #120. | [codegen-simple-marker spec](../plans/done/2026-05-07-codegen-simple-marker.spec.md) |  | — |
| Adding any `_Simple._` marker form to codegen — the trait-declaration `/// _Simple._` tag (PR #120) is the canonical signal; generated impls inherit it by Rust's rustdoc inheritance rules. | [codegen-simple-marker spec](../plans/done/2026-05-07-codegen-simple-marker.spec.md) |  | — |
| Other `impl Into<T>` / `impl AsRef<T>` / `impl ToString` sites beyond the four listed targets. If additional > 3-line-body sites are found during implementation, file a follow-up issue. | [generic-fn-split spec](../plans/done/2026-05-07-generic-fn-split.spec.md) |  | — |
...
| **Refactoring** any fn body to make it simple. Annotate only what already qualifies. | [recursive-inline-annotations spec](../plans/done/2026-05-07-recursive-inline-annotations.spec.md) |  | — |
...
| **API renames / signature changes.** Annotation-only PR. | [recursive-inline-annotations spec](../plans/done/2026-05-07-recursive-inline-annotations.spec.md) |  | — |
