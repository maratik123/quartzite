...
| `quartzite-widgets` | WidgetBase, WidgetExt, Layout, Button, Label, LineEdit, … — planned (#46) |
...
10. `quartzite-widgets` — WidgetBase + concrete widgets + layouts (blocked on #73 ✅ done → now unblocked, #46)
