...
///
/// ```
/// use quartzite_event_types::KeyEventKind;
///
...
///
/// ```
/// use quartzite_event_types::MouseEventKind;
///
...
///
/// ```
/// use quartzite_event_types::{EventType, KeyEventKind, MouseEventKind};
///
...
///
/// ```
/// use quartzite_event_types::{Event, EventType, KeyEventKind};
///
/// struct MyEvent;
...
///
/// ```
/// use quartzite_event_types::{Event, EventFilter, EventType};
/// use quartzite_core::ObjectId;
///
/// struct LogFilter;
