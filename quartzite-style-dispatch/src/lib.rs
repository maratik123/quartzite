...
//!     fn draw_text_in(&mut self, _r: quartzite_geometry::Rect, _t: &str, _f: &quartzite_paint_api::Font, _b: &quartzite_paint_api::Brush, _h: quartzite_geometry::HAlignment, _v: quartzite_geometry::VAlignment) {}
