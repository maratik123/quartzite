...
use quartzite_widgets::WidgetState;

pub use quartzite_hit_test::WidgetResolver;
...
mod tests {
    ...
    fn scroll_area_with_content_emits_clip_rect_between_save_and_translate() {
        ...
        assert_matches!(relevant[3], PaintEvent::Translate(_));
        assert_matches!(relevant[4], PaintEvent::FillRect);
        assert_matches!(relevant[5], PaintEvent::Restore);
    }
