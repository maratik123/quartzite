...
│       └── quartzite-renderer     ✅ multi-window (#53; WindowedAppHandler + WindowRegistry + try_create_window + per-window WidgetRoot dispatch; VelloPainter stub — new Painter methods remain no-op)
├── macros ✅
├── runtime ✅
│   ├── auto-connection ✅
